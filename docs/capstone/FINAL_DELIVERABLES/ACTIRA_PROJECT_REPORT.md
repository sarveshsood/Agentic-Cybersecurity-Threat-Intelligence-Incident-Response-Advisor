...
> **Pack root:** `docs/capstone/` · **Deliverables bundle:** `FINAL_DELIVERABLES/`  
> PPTX: `presentation/ACTIRA_Capstone_Presentation.pptx` · Appendices: `appendices/` · Assets: `assets/`  
> Evaluation focus is product capability (architecture, pipeline, HiTL, eval). Appendix E lists roles for completeness only.
