...
|------------|-------------------------------|
| Pipeline / parsers / IoC | Backend parsers, golden cases |
| RAG / playbooks / HiTL | Hybrid LanceDB RAG, playbook agent, review queue |
| Frontend workspace / dashboard | React SPA, live KPIs, investigation workspace |
